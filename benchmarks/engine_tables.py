...
computes medians and ratios. It measures nothing.
...
def main():
    ...
    if not as_text:
        ...
        out.append("historical arm has. Parse reads the input file, distance builds the")
        out.append("full matrix (on a sparse input that is the widening to +inf), graph")
        out.append("builds the sparse graph, and reduce is the engine alone. The")
    ...
    out.append("This table comes before the overall median on purpose: an overall")
    out.append("median over a corpus of unlike regimes hides the regime that lost.")
    out.append("")
